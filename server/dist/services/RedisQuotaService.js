...
class RedisQuotaService {
    constructor(logger) {
        this.dailyLimit = 100;
        this.DAILY_COUNT_KEY = 'email:daily:count';
        this.PAUSE_STATE_KEY = 'email:worker:paused';
        this.DAY_KEY_PREFIX = 'email:daily:';
        this.logger = logger;
     ...
     */
    async canSend(requestedCount = 1) {
        try {
...
export default (logger) => new RedisQuotaService(logger);
