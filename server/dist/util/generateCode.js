...
const getCSRFToken = async (authId) => {
    ...
    const message = authId.length + '!' + authId + '!' + randomValue.length + '!' + randomValue;
    const hmac = crypto
...
export { generateCode, getCSRFToken, validateCSRFToken, generateToken, getExpiryTime, verifyToken };
